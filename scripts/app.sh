#!/usr/bin/env bash
# ThumbRack app control — start the app DETACHED so it outlives the shell that launched it
...
APP="ThumbRack"
SERVER_PORT="${THUMBRACK_SERVER_PORT:-5021}"
CLIENT_PORT="${THUMBRACK_CLIENT_PORT:-5020}"
